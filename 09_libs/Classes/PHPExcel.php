...
class PHPExcel
{
    ...
    public function enregistre($format = 'Excel5',$nomFichier = 'Tableur'){
        ...
        switch($format){
            case 'Excel2007' :
                include CLASSES_FOLDER.'PHPExcel/Writer/Excel2007.php';
            ...
            case 'Excel2003' :
                ...
                break;
            case 'Excel5' :
                include CLASSES_FOLDER.'PHPExcel/Writer/Excel5.php';
                $writer = new PHPExcel_Writer_Excel5($this);
                $ext = 'xls';
                break;
            case 'CSV' :
                include CLASSES_FOLDER.'PHPExcel/Writer/CSV.php';
                ...
                break;
            case 'PDF' :
                include CLASSES_FOLDER.'PHPExcel/Writer/PDF.php';
                $writer  = new PHPExcel_Writer_PDF($this);
                $writer->setSheetIndex(0);//Une seule feuille possible
                $ext = 'pdf';
                break;
            case 'HTML' :
                include CLASSES_FOLDER.'PHPExcel/Writer/HTML.php';
        ...
        $writer->save(EXCEL_EXPORT_FOLDER.$nomFichier.'.'.$ext);
        header("Location: ".URL."modules/foad/export/files/".$nomFichier.'.'.$ext) ;
