...
//--- Acquisition des données en fonction du produit ($_SESSION['productID']) et de la langue ($_COOKIE['language']) ---//
    $userbdd = $bdd->prepare(' SELECT language, publishingDate, newspaper, articleTitle, postingDate, link FROM pressReview
...
//--- Acquisition du nombre de produits ---//
    ...
    $pathArticle = "01_pressReview/";
?>
    <meta name="robots" content="index, follow">
    <title><?php echo PRESS_REVIEW;?></title>
    </head>
    <body>
	...
	<div id="main">
		...
		<div id="content">
		    ...
		    <h1><?php echo PRESS_REVIEW;?></h1>
		    <table>
			<tr>
			    <th><?php echo PUBLISHING_DATE; ?></th>
			    <th><?php echo NEWSPAPER; ?></th>
			...
			for($i = 0; $i < count($_SESSION['article']); $i++)
			{
				...
				<td><?php echo $_SESSION['article'][$i]['newspaper'];?></td>
